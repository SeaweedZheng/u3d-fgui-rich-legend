...
public class PreloadAssetBundlesHelper 
{
    /// <summary> 存储需要预加载的 AB 包列表 </summary>
     ...
     {
         new object[]{"Assets/AstBundle/Games/PssOn00152 (1080x1920)/Prefabs/Page Game Main.prefab" },  //资源路径名（ab包）
     ...
     {
         new object[]{"Assets/AstBundle/Games/PssOn00152 (1080x1920)/Prefabs/Page Game Main.prefab" },  //资源路径名
     };
