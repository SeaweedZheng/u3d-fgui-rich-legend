...
public partial class ResourceManager : MonoSingleton<ResourceManager> { 
    ...
    /// 或 "Assets/AstBundle/Games/PssOn00152 (1080x1920)/ABs/Sprites/Symbol Icon/symbol_00.png"
    /// 或 "Assets/AstBundle/Games/PssOn00152 (1080x1920)/ABs/Sprites/Symbol Icon/symbol_00"
    ...
    string GetAssetBundleFilePath(string assetPathOrBundleName)
    {
        ...
        else
        {
            ...
            if (!assetPath.StartsWith("Assets/AstBundle/"))
                assetPath = assetPath + "Assets/AstBundle/";
    ...
    /* 
     public T Load<T>(string name) where T : Object
     {
         ...
         if (Application.isEditor) //加载U3d编辑器中的ab包资源
         {
             ...
             string path = "Assets/AstBundle/" + name;
         ...
         else //加载热更新ab包资源
         {
             string p = "";
             name = name.ToLower();
             p = Path.Combine(Application.persistentDataPath + "/AstBundle", name);
             //Debug.Log("path = " + path);
    ...
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="assetPathOrBundleName">"Assets/AstBundle/Games/PssOn00152/Prefabs/SpriteIcon.prefab"</param>
    /// <returns></returns>
