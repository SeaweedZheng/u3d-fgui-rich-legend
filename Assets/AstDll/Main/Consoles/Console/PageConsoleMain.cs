...
namespace ConsoleSlot01
{
    public class PageConsoleMain : PageBase
    {
        ...
        public static void OnBeforeCreat(Action onFinishCallback)
        {
            ...
            Action jsonFinishCB = () =>
            {
                ...
                FguiI18nManager.Instance.Add(I18nLang.cn,
                    "Assets/AstBundle/Consoles/Console/ABs/I18ns/language_cn_console_01.xml",
                    pkgName,
                    xmlFinishCB);
                FguiI18nManager.Instance.Add(I18nLang.tw,
                    "Assets/AstBundle/Consoles/Console/ABs/I18ns/language_tw_console_01.xml",
                    pkgName,
                    xmlFinishCB);
                FguiI18nManager.Instance.Add(I18nLang.en,
                    "Assets/AstBundle/Consoles/Console/ABs/I18ns/language_en_console_01.xml",
                    pkgName,
                    xmlFinishCB);
            };
            

            I18nMgr.Add("Assets/AstBundle/Consoles/Console/ABs/I18ns/i18nConsole001.json", pkgName, jsonFinishCB);
        ...
        void OnClickHardwareTest()=> PageManager.Instance.OpenPage(PageName.ConsolePageConsoleHardwareTest);

        void OnClickTouchCallbrate() => PageManager.Instance.OpenPage(PageName.ConsolePageDrawLine);

        void OnClickAdmin() => PageManager.Instance.OpenPage(PageName.ConsolePageConsoleAdmin);
        void OnClickExit()
        {
