...
static public class DefaultSettingsUtils
{
    ...
    [Tooltip("最小投币倍率(1币几分)")]
    static public int minCoinInScale = 10;
    [Tooltip("默认投币倍率(1币几分)")]
    static public int defCoinInScale = 10;
    ...
    [Tooltip("最小退票倍率(1票几分)")]
    static public readonly int minCoinOutCreditPerTicket = 0;
    [Tooltip("默认退票倍率(1票几分)")]
    static public readonly int defCoinOutCreditPerTicket = 200;
    ...
    [Tooltip("最小退票倍率(1分几票)")]
    static public readonly int minCoinOutTicketPerCredit = 0;
    [Tooltip("默认退票倍率(1分几票)")]
    static public readonly int defCoinOutTicketPerCredit = 0;
    ...
    static public int isDebugLog => ApplicationSettings.Instance.isRelease ? 0 : 1;
    ...
    static public int isUseReporterPage => ApplicationSettings.Instance.isRelease ? 0 : 1;
